...
// TODO
class SoulSandValleyBiome : Biome(Builder().surfaceBuilder(FSurfaceBuilders.SOUL_SAND_VALLEY, SOUL_SAND_CONFIG).precipitation(RainType.NONE).category(Category.NETHER).depth(0.1f).scale(0.2f).temperature(2.0f).downfall(0.0f).waterColor(4159204).waterFogColor(329011)) {
    init {
