...
object FFeatures {
    ...
    val NETHERRACK_BLOB_REPLACEMENT = NetherrackBlobReplacementFeature(::NetherrackBlobReplacementConfig).setRegistryKey("netherrack_blob_replacement")
    ...
    val BASALT_COLUMNS = BasaltColumnsFeature(::BasaltColumnsConfig).setRegistryKey("basalt_columns")
    val DELTA_FEATURE = DeltaFeature(::DeltaFeatureConfig).setRegistryKey("delta_feature")
    ...
    fun registerFeatures(features: IForgeRegistry<Feature<*>>) {
        if (FutureMC.DEBUG) {
            ...
            features.register(DELTA_FEATURE)
    ...
    fun addNetherOres(biome: Biome, a: Int = 16, b: Int = 16) {
