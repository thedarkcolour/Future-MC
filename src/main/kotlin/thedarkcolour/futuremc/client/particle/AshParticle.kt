...
class AshParticle(
    ...
    class AshFactory(private val spriteSet: IAnimatedSprite) : IParticleFactory<BasicParticleType> {
    ...
    class WhiteAshFactory(private val spriteSet: IAnimatedSprite) : IParticleFactory<BasicParticleType> {
        override fun makeParticle(p0: BasicParticleType, p1: World, p2: Double, p3: Double, p4: Double, p5: Double, p6: Double, p7: Double): Particle {
            val p = AshParticle(p1, p2, p3, p4, p5, p6, p7, spriteSet)
            p.particleRed = 0.7294118f
            p.particleGreen = 0.69411767f
            p.particleBlue = 0.7607843f
            return p
        }
    }
}