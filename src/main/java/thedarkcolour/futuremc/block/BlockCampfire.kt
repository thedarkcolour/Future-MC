...
class BlockCampfire : InteractionBlock("Campfire", Material.WOOD) {
    init {
...
*/
    ...
    companion object {
        private val BOUNDING_BOX = makeAABB(0.0, 0.0, 0.0, 16.0, 7.0, 16.0) //new AxisAlignedBB(0,0,0,1,0.375,1);
