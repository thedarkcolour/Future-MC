...
class BlockComposter : InteractionBlock("Composter", Material.WOOD) {
    ...
    companion object {
        ...
        protected val AABB_LEGS = makeAABB(0.0, 0.0, 0.0, 16.0, 2.0, 16.0)
    ...
    init {
        ...
        creativeTab = if (FConfig.useVanillaCreativeTabs) CreativeTabs.MISC else TAB
    }
}