...
public final class FutureConfig {
    ...
    public static class General {
        ...
        @Name("Trident enchantable in enchanting table")
        @Comment("Whether the Trident can be enchanted in the enchanting table. If false, you must first enchant books and apply them to the Trident.")
