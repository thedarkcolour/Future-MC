...
object FItems {
    ...
    fun init() {
        ...
        HONEYCOMB = register(ItemModeled("honeycomb").setCreativeTab(if (FConfig.useVanillaCreativeTabs) CreativeTabs.MISC else FutureMC.TAB), FConfig.buzzyBees.bee)
        HONEY_BOTTLE = register(ItemHoneyBottle(), FConfig.buzzyBees.bee)
        ...
        SALMON_BUCKET = register(ItemFishBucket("salmon_bucket", ::EntitySalmon), FConfig.updateAquatic.fish.salmon.enabled)
        COD_BUCKET = register(ItemFishBucket("cod_bucket", ::EntityCod), FConfig.updateAquatic.fish.cod.enabled)
        TROPICAL_FISH_BUCKET = register(ItemFishBucket("tropical_fish_bucket", ::EntityTropicalFish), FConfig.updateAquatic.fish.tropicalFish.enabled)
        NAUTILUS_SHELL = register(ItemModeled("nautilus_shell").setCreativeTab(if (FConfig.useVanillaCreativeTabs) CreativeTabs.MISC else FutureMC.TAB))
        ...
        register(ItemModeledBlock(FBlocks.SMITHING_TABLE), FConfig.villageAndPillage.smithingTable)
        register(ItemModeledBlock(FBlocks.CARTOGRAPHY_TABLE), FConfig.villageAndPillage.cartographyTable)
        ...
        //register(ItemModeledBlock(FBlocks.BELL), villageAndPillage.bell)
        //register(ItemModeledBlock(FBlocks.SCAFFOLDING), villageAndPillage.scaffolding)
        register(ItemModeledBlock(FBlocks.HONEY_BLOCK), FConfig.buzzyBees.honeyBlock)
        ...
        register(ItemModeledBlock(FBlocks.BEE_NEST), FConfig.buzzyBees.bee)
        register(ItemModeledBlock(FBlocks.BEEHIVE), FConfig.buzzyBees.bee)
