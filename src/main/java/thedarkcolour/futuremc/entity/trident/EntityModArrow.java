...
abstract class EntityModArrow extends EntityArrow implements IProjectile {
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.createKey(EntityModArrow.class, DataSerializers.BYTE);
    private static final DataParameter<Byte> PIERCE_LEVEL = EntityDataManager.createKey(EntityModArrow.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    protected EntityModArrow(World worldIn) {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    protected EntityModArrow(World worldIn, double x, double y, double z) {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    protected EntityModArrow(World worldIn, EntityLivingBase shooter) {
    ...
    public static DamageSource causeArrowDamage(EntityModArrow arrow, @Nullable Entity indirectEntityIn) {
