...
class RenderTropicalFish(manager: RenderManager) : RenderLiving<EntityTropicalFish>(manager, ModelTropicalFishA(), 0.15F) {
    ...
    override fun doRender(entity: EntityTropicalFish, x: Double, y: Double, z: Double, entityYaw: Float, partialTicks: Float) {
    ...
    override fun applyRotations(entityLiving: EntityTropicalFish, ageInTicks: Float, rotationYaw: Float, partialTicks: Float) {
