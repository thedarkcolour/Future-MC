...
class LayerIronGolemCrack(val renderer: RenderIronGolem) : LayerRenderer<EntityIronGolem> {
    override fun doRenderLayer(entitylivingbaseIn: EntityIronGolem, limbSwing: Float, limbSwingAmount: Float, partialTicks: Float, ageInTicks: Float, netHeadYaw: Float, headPitch: Float, scale: Float) {
    ...
    companion object {
        private val CRACK_TEXTURES = arrayOf(ResourceLocation(FutureMC.ID, "textures/entity/iron_golem/iron_golem_crackiness_low.png"), ResourceLocation(FutureMC.ID, "textures/entity/iron_golem/iron_golem_crackiness_medium.png"), ResourceLocation(FutureMC.ID, "textures/entity/iron_golem/iron_golem_crackiness_high.png"))
    }
}