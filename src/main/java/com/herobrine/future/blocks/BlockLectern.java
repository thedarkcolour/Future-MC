...
import com.herobrine.future.tile.lectern.GuiLectern;
import com.herobrine.future.tile.lectern.TileLectern;
...
public class BlockLectern extends BlockRotatable implements ITileEntityProvider {
    public BlockLectern() {
        ...
        setCreativeTab(FutureConfig.general.useVanillaTabs ? CreativeTabs.REDSTONE : Init.FUTURE_MC_TAB);
    }
