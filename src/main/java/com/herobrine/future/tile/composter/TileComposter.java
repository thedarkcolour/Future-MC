package com.herobrine.future.tile.composter;
...
public class TileComposter extends TileEntity {
    private final ItemStackHandler buffer = new ItemStackHandler() {
        ...
        public boolean isItemValid(int slot, ItemStack stack) {
            return ((BlockComposter)world.getBlockState(pos).getBlock()).canCompost(stack, world.getBlockState(pos));
        }
    ...
    private void handleStack(ItemStack stack) {
        if(((BlockComposter)world.getBlockState(pos).getBlock()).canCompost(stack, world.getBlockState(pos))) {
