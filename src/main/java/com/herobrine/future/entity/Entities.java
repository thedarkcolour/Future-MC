...
public class Entities {
    public static void init() {
        ...
        if(FutureConfig.general.trident) {
            EntityRegistry.registerModEntity(new ResourceLocation(Init.MODID,"trident"), EntityTrident.class,
                    "trident", id++, FutureMC.instance, 32, 1, true);
        }
        if(false) {
            EntityRegistry.registerModEntity(new ResourceLocation(Init.MODID, "drowned"), EntityDrowned.class,
                    "drowned", id++, FutureMC.instance, 36, 1, true);
        }
        if(FutureConfig.general.panda && FutureConfig.general.bamboo) {
            EntityRegistry.registerModEntity(new ResourceLocation(Init.MODID, "panda"), EntityPanda.class,
