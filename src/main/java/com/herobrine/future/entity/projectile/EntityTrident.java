package com.herobrine.future.entity.projectile;
...
public abstract class EntityTrident extends Entity implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityTrident.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityTrident.PickupStatus pickupStatus;
    ...
    public EntityTrident(World worldIn)
    {
        ...
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntityTrident.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
    ...
    public EntityTrident(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = EntityTrident.PickupStatus.ALLOWED;
        }
    }
    ...
    /**
     * Similar to setTridentHeading, it's point the throwable entity to a x, y, z direction.
     */
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            {
                damagesource = this.causeTridentDamage(this, this);
            }
            else
            {
                damagesource = this.causeTridentDamage(this, this.shootingEntity);
            }
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntityTrident.PickupStatus.ALLOWED)
                    {
                        this.entityDropItem(this.getTridentStack(), 0.1F);
                    }
    ...
    public static void registerFixesTrident(DataFixer fixer, String name)
    {
    }

    public static void registerFixesTrident(DataFixer fixer)
    {
        registerFixesTrident(fixer, "Trident");
    }
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntityTrident.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntityTrident.PickupStatus.ALLOWED : EntityTrident.PickupStatus.DISALLOWED;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntityTrident.PickupStatus.ALLOWED || this.pickupStatus == EntityTrident.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == EntityTrident.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getTridentStack()))
            {
                flag = false;
            }
    ...
    protected abstract ItemStack getTridentStack();
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityTrident.PickupStatus getByOrdinal(int ordinal)
        {
