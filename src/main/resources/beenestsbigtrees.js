                    ...
                    if (method.access === Opcodes.ACC_PUBLIC) {
                        ...
                        for (var j = 0; j < arrLength; ++j) {
                            ...
                            if (insn.getOpcode() == Opcodes.IRETURN && insn.getPrevious().getOpcode() == Opcodes.ICONST_1) {
                                ...
                                toInsert.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "thedarkcolour/futuremc/world/gen/BeeNestGenerator", "generateBeeNestForBigTrees", "(Lnet/minecraft/world/gen/IWorldGenerationReader;Ljava/util/Random;Lnet/minecraft/util/math/BlockPos;I)V", false));
